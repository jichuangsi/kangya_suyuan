      ...
      <div class="show_box" v-if="showsort">
        ...
        <div class="s_b_center" >
            <div class="s_li">
                <div class="s_right">
                    <div class="iptbox">
                        <input type="text" v-model="medicalnum" placeholder="病历号" @click.stop="">
                    </div>
                </div>
            </div>
            <div class="s_li">
                <div class="s_right">
                    <div class="iptbox">
                        <input type="text" v-model="name" placeholder="姓名" @click.stop="">
                    </div>
                </div>
            </div>
            <div class="s_li">
...
export default {
    ...
    return {
      top_data: {
        ...
        right_arr: [
          ...
          // { title: "新增", state: 2 },
          { title: "反馈", path: "/MFeedback",quer:'导诊', state: 1 }
        ]
      },
      guidance_arr: [
        {
  ...
  methods: {
    ...
    Go(item,index){
      this.$router.push({path:'/MG_into',query:{item:item}})
    }
  }
};
</script>
