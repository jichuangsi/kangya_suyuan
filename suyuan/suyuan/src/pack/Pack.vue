<template>
  <div class="Pack">
    ...
    <div class="foot">
      ...
      <div class="f_c">待打包器械共：798 损失/重洗：2</div>
      <div class="f_r">
    ...
    <div class="show" v-if="show" @click="show=false">
      ...
      <div class="show_box2" v-if="shownum == 1" @click.stop="">
        ...
        <div class="s_title" v-if="errorshow">损失/重洗列表 <div @click.stop="show1=true">新增</div></div>
    ...
    return {
      top_data: {
        ...
        right_arr: [
          ...
          { title: "反馈", path: "/Feedback",quer:'打包',state:1 }
        ]
      },
      pack_arr: [
        {
