  ...
  <div class="Inspection">
    ...
    <div class="center">
      ...
      <div class="foot">
        ...
        <div class="f_li">待检查消毒包：:<span>500</span></div>
        <div class="f_li">选中消毒包：<span>300</span></div>
        <div class="f_btn">
    ...
    <div class="show" v-if="show" @click="show=false">
      ...
      <div class="show_box2" v-if="shownum == 1" @click.stop="">
        ...
        <div class="s_btn">
            ...
            <div @click.stop="show2=true">打印标签</div>
        </div>
      </div>
    ...
    return {
      top_data: {
        ...
        right_arr: [
          ...
          { title: "反馈", path: "/MFeedback",quer:'质检',state:1 }
        ]
      },
      inspection_arr: [
        {
